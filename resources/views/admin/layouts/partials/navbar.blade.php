                    ...
                    <div class="dropdown ms-sm-3 header-item topbar-user">
                        <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown"
                            ...
                            <span class="d-flex align-items-center">
                                ...
                                <span class="text-start ms-xl-2">
                                    <span class="d-none d-xl-inline-block ms-1 fw-medium user-name-text">{{session('nhanVien')->hoTen }}</span>
                                    <span class="d-none d-xl-block ms-1 fs-12 user-name-sub-text">{{session('nhanVien')->chucVu}}</span>
                                </span>
                            </span>
                        </button>
                        <div class="dropdown-menu dropdown-menu-end">
                            ...
                            <h6 class="dropdown-header">
                                Welcome {{session('nhanVien')->hoTen}}!
                            </h6>
                            <a class="dropdown-item" href="{{route('nhanvien.show', session('nhanVien')->maNhanVien)}}"><i
                                    class="mdi mdi-account-circle text-muted fs-16 align-middle me-1"></i>
                                <span class="align-middle">Profile</span></a>
                            <form action="{{route('logout')}}" class="dropdown-item" method="POST" >
                                @csrf<i
                                    class="mdi mdi-logout text-muted fs-16 align-middle me-1"></i>
                                <button type="submit" class="border-0 bg-transparent"><span class="align-middle" data-key="t-logout">Logout</span></button> </form>
                        </div>
                    </div>
                @endif
            </div>
